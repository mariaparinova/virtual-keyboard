const keyboardKeysEn = [
  [
    ...
    {
      val: 1, subval: '!', code: 'Digit1', print: true,
    },
    {
      val: 2, subval: '@', code: 'Digit2', print: true,
    },
    {
      val: 3, subval: '#', code: 'Digit3', print: true,
    },
    {
      val: 4, subval: '$', code: 'Digit4', print: true,
    },
    {
      val: 5, subval: '%', code: 'Digit5', print: true,
    },
    {
      val: 6, subval: '^', code: 'Digit6', print: true,
    },
    {
      val: 7, subval: '&', code: 'Digit7', print: true,
    },
    {
      val: 8, subval: '*', code: 'Digit8', print: true,
    },
    {
      val: 9, subval: '(', code: 'Digit9', print: true,
    },
    {
      val: 0, subval: ')', code: 'Digit0', print: true,
    },
    {
      val: '-', subval: '_', code: 'Minus', print: true,
    },
    {
      val: '+', subval: '=', code: 'Equal', print: true,
    },
    { val: 'Backspace', code: 'Backspace' },
  ],
  [
    { val: 'Tab', code: 'Tab' },
  ...
  [
    ...
    { val: '↓', code: 'ArrowDown', print: true },
    { val: '→', code: 'ArrowRight', print: true },
  ],
];
